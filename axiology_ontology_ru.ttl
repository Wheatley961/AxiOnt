...
ONTOLOGY_URL = "https://github.com/Wheatley961/AxiOnt/blob/main/axiology_ontology_ru.ttl"
...
def main():
    ...
    with st.expander("Описание проекта и назначение онтологии", expanded=True):
        st.markdown("""
        Онтология создана для формального представления государственной ценностной политики и моделирования взаимосвязей между ценностями, целями, задачами, инструментами и участниками. Концептуальная база включает официальный перечень традиционных ценностей по Приказу Президента РФ №809, принципы государственной гуманитарной политики, анализ угроз ценностному суверенитету, а также сценарный и программно-целевой подходы. Онтология реализована в парадигме OWL.
